...
| `unknown` | `null` | The request did not complete, **or** the node answered without saying yes or no. It **may** still have reached the mempool — check the `txid` before rebuilding |
